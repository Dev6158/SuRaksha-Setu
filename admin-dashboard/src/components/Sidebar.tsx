...
export default function Sidebar({ activeTab, setActiveTab }: SidebarProps) {
  const tabs = [
    ...
    { 
      ...
      icon: (
        <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M12 11c0 3.517-1.009 6.799-2.753 9.571m-3.44-2.04l.054-.09A13.916 13.916 0 009 11a13.918 13.918 0 00-6.125-11.538M3.5 20.5a9 9 0 0110.66-10.66M12 11c0-1.83 1.344-3.346 3.125-3.627A13.978 13.978 0 0116.125 10c0 3.517-1.009 6.799-2.753 9.571M19.5 20.5a9 9 0 00-3.375-9.571m-3.44-2.04l.054-.09A13.916 13.916 0 0016 11a13.918 13.918 0 006.125-11.538" />
        </svg>
      )
    },
    { 
      ...
      <ul className="space-y-2 flex-grow">
        {tabs.map((tab) => (
          <li
            ...
            className={`p-3 rounded-lg cursor-pointer transition-all duration-150 flex items-center space-x-3 ${
              activeTab === tab.id
