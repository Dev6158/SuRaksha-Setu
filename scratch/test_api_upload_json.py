...
file_path = "/home/debanshhota/SuRaksha-Setu/Sample_aadhar.json"

print("=============================================")
print("🚀 Testing API Upload on Sample_aadhar.json")
print("=============================================")
...
with open(file_path, "rb") as f:
    # Let requests send the file. By default, it will detect application/json based on .json extension
    files = {"file": (os.path.basename(file_path), f, "application/json")}
    data = {"purpose": "Automated JSON Verification Test"}
